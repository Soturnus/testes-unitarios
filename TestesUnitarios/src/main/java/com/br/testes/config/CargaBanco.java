...
public class CargaBanco implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Trabalhador t2 = new Trabalhador(null, "Thomas", 28, "13474562444", 47.8, 18);
		Trabalhador t3 = new Trabalhador(null, "Ayrton", 27, "22527433448", 51.2, 15);
		Trabalhador t4 = new Trabalhador(null, "Teste", 1, "84081116474", 10.7, 31);
